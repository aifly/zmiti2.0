...
const router = new VueRouter({
	routes: [
		...
		{ path: '/resourcelist/:id?', name: 'resourcelist', component: (resolve) => require(['./admin/resourcelist'], resolve) },
		...
		{ path: '/news/', name: 'news', component: (resolve) => require(['./admin/news'], resolve) },
		{
			path: '/group/', name: 'group', component: (resolve) => require(['./common/group'], resolve), props: true, children: [
				...
				{ path: '/adminchangyuesetting', name: 'adminchangyuesetting', component: (resolve) => require(['./admin/changyuesetting'], resolve) },
				{ path: '/adminchangyuelog', name: 'adminchangyuelog', component: (resolve) => require(['./admin/changyuelog'], resolve) },
