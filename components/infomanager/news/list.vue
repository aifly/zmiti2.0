...
<script>
	...
	export default {
								...
								h('span',{
									...
									on:{
										click:()=>{
											...
											this.$router.push({name:'infomanagernewsdetail',params:{typeid:this.typeid,id:this.formObj.infoid}});
										}
									}
								},'编辑'),
								h('Poptip',{
		...
		methods:{
			...
			add(){
				this.$router.push({name:'infomanagernewsdetail',params:{typeid:this.typeid}})				
			},
			getDataList(){
				var s = this;
				var {condition} = this;
