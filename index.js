  ...
  routes: [
	...
	},
	{
		path: '/group/', name: 'group', component: Group, children: [
			...
			{ path: "/infomanager/:productid?", name: "infomanager", component: infomanager},
			...
			{path:"/infomanagerlistdetail/:productid?/:typeid?/:id?",name:"infomanagerlistdetail",component:infomanagerlistdetail},
			{path:"/infomanagernews/:id?",name:"infomanagernews",component:infomanagernews},
			{path:"/infomanagernewsdetail/:productid?/:typeid?/:id?",name:"infomanagernewsdetail",component:infomanagernewsdetail},
			...
			{path:"/infomanagerboxdetail/:productid?/:typeid?/:id?",name:"infomanagerboxdetail",component:infomanagerboxdetail},
